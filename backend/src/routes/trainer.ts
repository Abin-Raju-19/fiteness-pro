...
trainerRouter.get('/athletes', async (req: AuthedRequest, res) => {
  try {
...
trainerRouter.post('/assign-plan', async (req: AuthedRequest, res) => {
...
trainerRouter.post('/assign-diet-plan', async (req: AuthedRequest, res) => {
...
// Start live session
trainerRouter.post('/live-session', async (req: AuthedRequest, res) => {
